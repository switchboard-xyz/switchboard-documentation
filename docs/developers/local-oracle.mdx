...
services:
  switchboard:
    ...
    environment:
      ...
      - ORACLE_KEY=${ORACLE_KEY}
      - HEARTBEAT_INTERVAL=15
      - GOOGLE_PAYER_SECRET_PATH="projects/202232388340/secrets/oracle-payer-secret"
      # GCP resource path containing your configuration bucket
      - GCP_CONFIG_BUCKET=""
```
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        ...
        <br />
        <a href="../oracle/google#google-secret-manager">
    ...
    <tr>
      ...
      <td>
        ...
        <br />
        Dictates which metric suited to aggregate resource metrics defined in:
        <br />
