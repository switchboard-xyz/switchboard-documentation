...
The Switchboard oracle is a node image that sits between the internet and a Solana RPC node and facilitates update request when invoked by a queue. Before running an oracle you will need to

- Create an oracle account for a specified queue
- Fund oracle staking wallet with minimum stake set by the queue
- Get approved to join the queue by the queue authority
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <a href="../oracle/kubernetes/google#authentication">
  ...
  <tr>
    ...
    <td>
      <a href="../oracle/kubernetes/google#static-ip">
  ...
  <tr>
    ...
    <td>
      <a href="../oracle/kubernetes/google#google-secret-manager">
  ...
  <tr>
    ...
    <td>
      <a href="../oracle/kubernetes/google#service-account">
  ...
  <tr>
    ...
    <td>
      <a href="../oracle/grafana#hostname">Grafana #Hostname</a>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <br />
      <a href="../oracle/grafana#tls-certificate">Grafana #TLS Certificate</a>
    </td>
  </tr>
  <tr>
