...
- **Oracle**: Node between the internet and the solana blockchain responsible for fuliflling data feed updates from external sources. The initial implementation will support up to 1024 oracles, although it can support up to 100,000 oracles if rent exemptions were ignored.
