...
<table>
  ...
  <tr>
    <td>Start After</td>
    <td>
      Timestampt to start feed updates at. Useful if you are resolving a sport
      event that ends around a certain time
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <br />
      <strong>AggregatorRound</strong> See table below
    </td>
  </tr>
  <tr>
    <td>Current Round</td>
