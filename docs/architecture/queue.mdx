...
<table>
  ...
  <tr>
    <td>Authority</td>
    <td>
      Queue operator who approves permission accounts.
      <br />
      The <strong>Switchboard DAO</strong> will operate oracle queue's with a
  ...
  <tr>
    ...
    <td>Number of standard deviations before an oracle results is considered invalid</td>
  </tr>
  <tr>
